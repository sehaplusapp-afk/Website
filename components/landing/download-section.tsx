...
>
  ...
  >
    ...
    <FaApple className="relative z-10 w-7 h-7" />
    ...
    <div className="text-start">
      ...
      <span className="text-lg font-bold">Google Play</span>
          ...
          <motion.div
            ...
            className="flex flex-wrap items-center justify-center gap-3 md:gap-4 text-white/85 text-sm"
          >
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/8 backdrop-blur-md border border-white/12">
              <Shield className="w-4 h-4 text-white/80" />
              <span>
                {dir === "rtl"
                  ? "تجربة صحية رقمية سهلة"
                  : "Simple digital care experience"}
              </span>
            </div>
